...
public class Main implements IXposedHookLoadPackage
{
    ...
    public boolean hack_enabled()
    {
        ...
        log_call("master_switch=" + master_switch);

        boolean app_enabled = pref.getBoolean(lpparam.packageName, false);
        log_call("app_enabled=" + app_enabled);
    ...
    {
        Log.e("aaaaaaaaaaaaaaaaaaaaa", "doit_networkinfo="+called);
        if (!hack_enabled())
        {
    ...
    {
        Log.e("aaaaaaaaaaaaaaaaaaaaa", "createNetworkInfo=" + type);
    ...
    public Object createWifiSsid() throws Exception
    {
        ...
        Object wifissid = XposedHelpers.callStaticMethod(cls, "createFromAsciiEncoded", "yingsheng4");
        return wifissid;
    }
    ...
    public WifiInfo createWifiInfo() throws Exception
    {
        ...
        XposedHelpers.setObjectField((Object)info, "mBSSID", "78:d3:8d:e0:92:25");
        XposedHelpers.setObjectField((Object)info, "mMacAddress", "02:00:00:00:00:00");
        XposedHelpers.setObjectField((Object)info, "mIpAddress", addr);
        XposedHelpers.setIntField((Object)info, "mLinkSpeed", 40);  // Mbps
        if (Build.VERSION.SDK_INT >= 21) XposedHelpers.setIntField((Object)info, "mFrequency", 2462); // MHz
        ...
        {  XposedHelpers.setObjectField((Object)info, "mSSID", "yingsheng4");  }	      // Jellybean
    ...
    {
        if ("com.alibaba.android.rimet".equals(lpp.packageName) || "com.lemonsqueeze.testwifi".equals(lpp.packageName)) {
            hackWifi(lpp);
        } else {
            return;
        }
    ...
    private void hackWifi(final LoadPackageParam lpp) {
        pref = new XSharedPreferences(Main.class.getPackage().getName(), "pref");
        lpparam = lpp;
        Log.e("FakeWifiConnection", "aaaaaaaaaaaaaaaaaaaaapackageName=" + lpparam.packageName);
